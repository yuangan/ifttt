		...
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<p>please choose the work you want to delete</p>
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-3 col-md-3">
                ...
                <div class="service-box">
					...
					<form action="delete_timer" id="delete_timer" method="post">		
						<h5>Set Timer</h5>
						<p>
						Set the time to start the work
						</p>
						<input type="submit" value="Dreate" class="btn btn-skin">
			...
			<div class="col-xs-6 col-sm-3 col-md-3">
                ...
                <div class="service-box">
					...
					<div class="service-desc">
						<form action="delete_weibo" id="delete_weibo" method="post">	
						<h5>Weibo</h5>
						<p>
						Set the Weibo Mission.
						</p>
						<input type="submit" value="Delete" class="btn btn-skin">
			...
			<div class="col-xs-6 col-sm-3 col-md-3">
                ...
                <div class="service-box">
					...
					<div class="service-desc">
						<form action="delete_mail" id="delete_mail" method="post">	
						<h5>Mail</h5>
						<p>
            ...
            <div class="col-xs-6 col-sm-3 col-md-3">
                ...
                <div class="service-box">
					...
					<div class="service-desc">
						<form action="delete_timeweibo" id="delete_timeweibo" method="post">	
						<h5>Mail</h5>
						<p>
